...
public interface ModItems
{
    ...
    DeferredItem<Item> CRYSTAL_HOOK = HOOKS_REGISTRY.register("crystal_hook", () -> new CatchModifierItem(ModCatchModifiers.SURVIVES_LAVA));
    ...
    //baits
    DeferredItem<Item> WORM = ITEMS.register("worm", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> ALMIGHTY_WORM = ITEMS.register("almighty_worm", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME, ModCatchModifiers.FISH_ENTITY));
    DeferredItem<Item> SEEKING_WORM = ITEMS.register("seeking_worm", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME, ModCatchModifiers.GUARANTEE_NEW_FISH_ALWAYS));
    DeferredItem<Item> DEV_WORM = ITEMS.register("dev_worm", BasicItem::new);

    DeferredItem<Item> GUNPOWDER_BAIT = ITEMS.register("gunpowder_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> CHERRY_BAIT = ITEMS.register("cherry_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> LUSH_BAIT = ITEMS.register("lush_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> SCULK_BAIT = ITEMS.register("sculk_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> DRIPSTONE_BAIT = ITEMS.register("dripstone_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> MURKWATER_BAIT = ITEMS.register("murkwater_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    DeferredItem<Item> LEGENDARY_BAIT = ITEMS.register("legendary_bait", () -> new CatchModifierItem(64, ModCatchModifiers.DECREASES_LURE_TIME));
    ...
    DeferredItem<Item> CLAM = ITEMS.register("clam", BasicItem::new);
    ...
    DeferredItem<Item> COOKED_STARCAUGHT_FISH = ITEMS.register("cooked_starcaught_fish", () -> new Item(new Item.Properties().food(ModFoodProperties.BASIC_COOKED_FISH)));
