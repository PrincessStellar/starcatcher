...
public class SellingBinMenu extends AbstractContainerMenu
{
    ...
    public SellingBinMenu(int containerId, Inventory playerInventory, Container container, BlockEntity blockEntity)
    {
        ...
        this.addSlot(new SellingBinItemSlot(this, container, ITEM_SLOT, 56, 38, blockEntity != null));

        this.addSlot(new SellingBinResultSlot(this, container, RESULT_SLOT, 104, 38, blockEntity != null));
